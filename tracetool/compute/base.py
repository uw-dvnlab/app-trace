"""
Tracetool Compute Base

Base class for all compute/metric plugins.
Compute modules calculate metrics from signals and events.
"""

from tracetool.data.descriptors import EventSpec, ChannelSpec, RunData
from tracetool.data.resolve import resolve_all, resolve_events
import pandas as pd
...
class ComputeBase(ABC):
    ...
    def _export_result(
        ...
        from tracetool.data.loader import save_compute_export, save_compute_provenance
