...
PROJECT_MANIFEST = "tracetool.yaml"
...
def _copy_template_notebooks(notebooks_dir: Path) -> None:
    """Copy template notebooks from tracetool/templates to project notebooks folder."""
    import shutil
...
def load_project(path: Path) -> ProjectConfig:
    ...
    If no tracetool.yaml exists, uses default structure.
...
def _parse_project_config(root: Path, data: dict[str, Any]) -> ProjectConfig:
    """Parse a tracetool.yaml into ProjectConfig."""
