...
from tracetool.gui.plot.plotrow import PlotRow, PlotControlPanel
from tracetool.gui.plot.plotrow_unified import PlotRowWidget
from tracetool.gui.plot.channel_browser import ChannelBrowser
from tracetool.gui.dialogs import DerivativeDialog, FilterDialog, AverageChannelsDialog
from tracetool.processing.channel_utils import (
    create_derived_channel,
    create_averaged_channel,
)

from tracetool.data.descriptors import Event
