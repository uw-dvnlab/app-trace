...
from tracetool.data.loader import (
    load_session,
    load_session_from_project,
    get_modality_channels,
)
from tracetool.project import load_project
from tracetool.project.structure import PROJECT_MANIFEST
from tracetool.gui.plot_window import PlotWindow
from tracetool.gui.panels.events_panel import EventsPanel
...
<p><b>Repository:</b> <a href="https://github.com/uw-dvnlab/app-trace">github.com/uw-dvnlab/app-trace</a></p>
<hr>
<p><i>If you use this software in your research, please cite it.</i></p>
"""
    ...
    def save_run_config(self, run_data):
        ...
        from tracetool.data.loader import save_run_config
    ...
    def _load_session_from_path(self, folder_path: Path):
        ...
        # Check if this is a project folder (has tracetool.yaml)
    ...
    def _discover_project_plugins(self, project_config):
        ...
        from tracetool.registry.discovery import discover_annotators, discover_compute
        from tracetool.annotate import get_registry as get_annotator_registry
        from tracetool.compute import get_registry as get_compute_registry
