...
from tracengine.data.descriptors import RunData, RunConfig
from tracengine.project.config import ProjectConfig, PipelineConfig
...
class PipelineRunner:
    ...
    def __init__(
        ...
        # Load registries
        from tracengine.annotate import list_annotators, get_annotator
        from tracengine.compute import list_compute, get_compute
    ...
    def _run_preprocessing(
        ...
        try:
            from tracengine.processing.channel_utils import create_derived_channel
